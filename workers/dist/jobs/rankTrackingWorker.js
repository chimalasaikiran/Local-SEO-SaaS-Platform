...
exports.handleRankTrackingJob = void 0;
...
const handleRankTrackingJob = async (jobData) => {
    ...
    try {
        ...
        if (configResult.rows.length === 0)
            throw new Error('Config not found or tenant mismatch');
        ...
        if (keywordResult.rows.length === 0)
            throw new Error('Keyword not found or tenant mismatch');
        ...
        if (gridPointResult.rows.length === 0)
            throw new Error('Grid point not found or tenant mismatch');
...
exports.handleRankTrackingJob = handleRankTrackingJob;
