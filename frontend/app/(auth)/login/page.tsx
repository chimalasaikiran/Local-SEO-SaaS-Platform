...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-green-50/30 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* Floating Badges */}
        <div className="absolute -top-12 -right-8 bg-white shadow-xl rounded-xl p-3 flex flex-col items-center animate-bounce" style={{ animationDuration: '3s' }}>
          <div className="flex items-center space-x-2">
        ...
        <div className="absolute -bottom-6 -left-12 bg-white shadow-xl rounded-xl p-3 flex items-center space-x-3">
